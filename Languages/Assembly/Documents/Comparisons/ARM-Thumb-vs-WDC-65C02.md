# ARM-Thumb vs WDC-65C02

## Overview

This document compares **ARM-Thumb** and **WDC-65C02**, two distinct assembly architectures with different design goals, historical contexts, and technical approaches.

| Attribute | ARM-Thumb | WDC-65C02 |
|-----------|----------|----------|
| **Bits** | 16/32 | 8 |
...
**Key Difference:** ARM-Thumb approaches computing with a risc philosophy, while WDC-65C02 takes a cisc approach. 
...
**Comparison:** ARM-Thumb offers many registers (many-style architecture), while WDC-65C02 provides few registers (few-style architecture). This fundamentally affects how code is structured and optimized.
...
ARM-Thumb and WDC-65C02 represent different points in the spectrum of processor design. The 8-bit WDC-65C02 and 16/32-bit ARM-Thumb serve different scale requirements. WDC-65C02 excels in constrained environments where every transistor counts, while ARM-Thumb provides the address space and arithmetic range needed for complex modern workloads.
